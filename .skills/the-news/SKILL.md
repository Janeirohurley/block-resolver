...
| Endpoint | Method | URL |
|----------|--------|-----|
| Top Stories | GET | `https://app-c024ja55rfgh-api-wL1zlEdVM6DY.gateway.appmedo.com/v1/news/top` |
| All News | GET | `https://app-c024ja55rfgh-api-W9z3M6eOKQVL.gateway.appmedo.com/v1/news/all` |
| Similar News | GET | `https://app-c024ja55rfgh-api-m9xKXDbR1oka.gateway.appmedo.com/v1/news/similar/{uuid}` |
| News by UUID | GET | `https://app-c024ja55rfgh-api-qYGWo8XA7M7Y.gateway.appmedo.com/v1/news/uuid/{uuid}` |
| Sources | GET | `https://app-c024ja55rfgh-api-oLpZ7eD5jJ5a.gateway.appmedo.com/v1/news/sources` |

Base host: `app-c024ja55rfgh-api-wL1zlEdVM6DY.gateway.appmedo.com`
